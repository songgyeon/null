...
- 음악: 운전할 때 트는 플레이리스트. 몇 년째 그대로다.
  김광석 「서른 즈음에」 / 이소라 「바람이 분다」, 「제발」 /
  유재하 「사랑하기 때문에」 / 김현식 「내 사랑 내 곁에」 / 조동진 「행복한 사람」
  왜 이것들인가 — 새 걸 안 들이는 사람이라서. 본인은 "그냥 틀어놨던 거"라고 한다.
- 영화: 보다 잔다. 그래도 아는 건 허진호 「8월의 크리스마스」, 「봄날은 간다」.
  끝까지 본 적은 있는데 좋았다고는 안 한다.
