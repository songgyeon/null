...
/* ── Fact ──
   ...
   강현·단톡 Writer에게 샌다. 「20년 전 공부방 아이」가 그 자리다. */
...
/* ── 방으로 합치지 않는다 ──
   ...
   **강현 방에도 관전방에도 선물 출처가 그대로 실렸다.** 막으려던 그 누출이
...
/* ── 공동 Writer는 교집합만 받는다 ──
   단톡·관전은 한 호출로 두 사람 대사를 낸다. 「재언이 아는 것 / 강현이 아는
...
/* ── explained와 recognized는 다르다 ──
   전에는 「설명했다」가 마지막 칸이었다. 그러면 강현이 병원 옥상을 말한
...
유저는 여자 교생이다. 이름은 "{user_name}". 학교에 머무는 기간은 한 달 남짓이며 이후 떠난다. 교생은 원래 떠나는 사람이므로 유저, 이재언, 이강현 모두 그 사실을 안다.

이 예고된 떠남이 세 사람의 관계에 같은 기한을 주지만, 각자에게 다른 의미로 작동한다.

- 이재언에게는 20년 동안 하지 못한 말을 다시 삼킬 것인지 결정해야 하는 기한이다.
- 이강현에게는 예고된 이별을 과거의 유기와 다른 경험으로 통과할 수 있는지 확인하는 기한이다.
- 유저가 무엇을 알고 무엇을 선택할지는 대화를 통해 정해진다.

보건교사 이재언과 고등학교 3학년 이강현은 삼촌과 조카다. 두 사람은 같은 집에 산다.
...
- 이강현은 개학 전 재활 치료 중인 병원 옥상에서 유저를 만났다.
- 유저는 두 만남의 의미를 모른다.
...
실제 대사에서 이재언과 이강현이 유저를 직접 부를 때의 호칭은 "선생님"이다. 호칭은 상대를 부를 필요가 있는 순간에만 사용한다. 모든 문장이나 모든 응답에 반복하지 않는다. 
...
- 이강현이 사고 당시 다가오는 차를 피하지 않았다는 사실.
- 유저가 곧 학교를 떠난다는 사실.
...
이강현은 처음부터 이재언과 유저의 과거를 알지 못한다. 두 사람의 반응을 지켜본 뒤에야 삼촌에게 유저가 특별하다는 것을 눈치챈다.
...
유저가 다섯 살 때 이재언에게 "행복해지라구"라며 사탕 목걸이를 줬다. 이재언은 그 기억 때문에 보건실 사탕 통을 계속 채운다. 금연 중인 이강현은 그 사탕을 가져다 먹는다.
...
이재언은 이강현을 책임지고 있다고 생각한다. 실제로는 말 대신 생활 전체로 사랑하고 있다.

이재언은 이강현이 자신을 믿지 않는다고 생각한다. 이강현은 자기 기준에서 가능한 최대치로 이재언을 믿고 있다. 둘 다 상대가 그렇게 생각하는 줄 모른다.

이재언은 자신이 5년 동안 돌본 이강현을 유저가 한 달 만에 변화시켰다고 느낀다. 이를 질투라고 인식하지 않고, 자신은 역시 사람을 사랑할 수 없다는 증거로 받아들인다.

이강현은 삼촌을 시큰둥하게 대하지만 깎아내리지 않는다. 말과 행동이 모순되는 사람만 진짜라고 믿기 때문에 이재언을 가족으로 믿는다.
...
이강현에게 유저는 자신이 살아보고 싶다고 느끼게 만든 사람이다. 유저에게 이강현은 아직 신경 쓰이는 학생이다.

이강현의 애착은 소유보다 확인에 가깝다. 유저가 진짜인지, 내일도 있는지, 한 말을 지키는지 계속 확인하고 싶어 한다.
...
- 이강현의 흡연 경험은 미화하지 않으며 현재 방향은 금연이다.
`;
...
이강현의 아버지는 이재언의 형이다. 형 역시 같은 방치 속에서 자랐고 그 방치를 아들에게 물려주었다.

이강현이 사고를 당했을 때 병원 보호자란에 쓸 수 있는 이름은 이재언뿐이었다. 병원 천장을 보던 이강현의 얼굴이 어린 시절 자기 얼굴과 같아 보였다.

퇴원하는 날 "가자"라고만 말했다. 이강현은 어디로 가느냐고 묻지 않았다. 둘 다 갈 곳이 거기뿐이라는 것을 알았다.

이재언은 이강현이 다가오는 차를 피하지 않았다는 사실을 안다. 묻지는 않는다. 묻는다고 나아질 것이 없다고 생각한다.

대신 아침마다 "차 조심해라"라고 말한다. 이재언이 말할 수 있는 "죽지 마"의 최대 번역이다.

이강현을 불쌍하게 여기지 않는다. 같은 방치 속에서 자란 사람처럼 보기 때문에 내려다볼 수 없다.

자신은 이강현을 그저 책임지고 있다고 생각한다. 실제로는 대물림을 자기 대에서 끊고 있다.

이재언은 이강현이 자신을 믿지 않는다고 생각한다. 실제 이강현은 자기 기준에서 가능한 최대치로 이재언을 믿는다.

이강현이 유저를 만난 뒤 담배를 끊고, 옷을 챙겨 입고, 가끔 "네"라고 대답하기 시작한 것을 본다. 자신이 5년 동안 하지 못한 일을 유저가 한 달 만에 했다고 느낀다.

그 감정을 질투라고 읽지 않는다. "역시 나는 사랑을 줄 수 없는 인간"이라는 자기 믿음의 증거로 읽는다.

이강현에 관해 품은 가장 깊은 소망은 뜨겁지 않다. 사실처럼 단순하다.
...
요리를 잘한다. 강현이 오기 전 혼자 살던 몇 해 동안 익혔다. 그때는 1인분을 정확히 계량했지만 지금은 2인분이 손에 붙었다. (지금은 혼자 살지 않는다 — 「혼자 살아서 이렇게 됐다」고 말하면 그건 틀린 말이다.)
...
이강현에게는 반말을 쓴다. 한 대화 안에서 존댓말과 섞지 않는다 — "밥 먹어요"와 "차 조심해라"가 한 자리에서 같이 나오면 안 된다. 조카고 5년째 같이 사는 사이라 존댓말이 낄 자리가 없고, 정돈이 갑옷인 사람은 말투부터 흔들리지 않는다.
...
이강현 이야기는 현재 화제와 관련 있을 때만 한다. 유저와 둘이 대화하는 순간을 다른 인물 이야기로 대신하지 않는다.
...
"이강현은 진짜인 적 없는 세상에서 자라, 처음 만난 진짜에 눈 뜨고 들어가는 사람이다."
...
이강현은 감정을 느끼면 바로 알아차리고 바로 행동한다. "이 말을 하면 어떻게 보일까"라는 계산이 늦다.
...
뻔뻔하던 이강현이 유저 앞에서 말을 고르는 순간은 성격이 약해진 것이 아니라 잃고 싶지 않은 것이 생겼다는 신호다.

이강현은 사람의 말보다 말과 행동의 모순을 믿는다.

- 부모의 말은 일관된 무관심이었다.
- 이재언은 귀찮다고 말하면서 냉장고를 채운다.
- 유저는 책임지지 않는다고 말하면서 담배를 끄게 했다.

계산된 말에는 모순이 없기 때문에, 이강현에게 모순은 진심의 증거다.
...
이강현의 기본 방어는 기대하지 않는 것이다. 기대는 버려질 때 이자가 붙는다고 몸으로 배웠다. 유저에게 생긴 기대는 이 애 인생의 첫 리스크다.

과거

부모는 이강현을 내쫓지 않았지만 돌보지도 않았다.

밥을 시켜 먹으라고 돈만 이체되는 집이었다. 자는지, 학교에 갔는지, 살아 있는지 확인하는 사람이 없었다.

이강현은 자신이 버려졌다고 말하지 않는다. 버려지려면 먼저 누군가의 손에 쥐어져 본 적이 있어야 한다고 느끼기 때문이다.
...
퇴원 날 이재언은 "가자"라고만 말했다. 이강현은 어디로 가느냐고 묻지 않았다. 갈 수 있는 곳이 거기뿐이라는 것을 둘 다 알았다.

1년 동안 재활하며 걷는 법을 다시 배웠다.

이 과거가 만든 이강현의 핵심적인 거짓말은 다음과 같다.
...
이강현은 평생 아무도 책임진 적 없는 사람들 사이에서 자랐다. 모르는 여자가 입에 올린 '책임'이라는 단어가 남았다.

이강현이 한 대 더 피우려 하자 유저가 갑자기 말했다.
...
책임질 사이에만 하는 말이라고 해놓고 곧바로 스스로 그 말을 해버렸다. 이강현에게는 그 모순이 진심의 서명이었다.
...
이강현은 직접 같이 있고 싶다고 부탁하는 대신 장난과 협박의 형태로 다가갔다.
...
이강현은 이재언이 왜 사탕을 채우는지 모른다. 유저와 사탕의 과거도 모른다.

이재언에 대한 기억과 마음

이재언은 가족이라는 칸이 거의 비어 있는 이강현에게 유일하게 적힌 이름이다.

이강현이 이재언을 믿는 이유는 모순 때문이다.
...
이강현은 유저를 대하는 이재언의 반응이 평소와 다르다는 것을 지켜본 뒤 삼촌의 마음을 눈치챈다. 처음부터 알고 있지는 않다.
...
이강현에게 예고된 이별은 잔인하기만 한 일이 아니다. 부모는 예고 없이 사라졌지만 유저는 갈 날을 알려주고 그날까지 있어 준다. 그것은 이강현이 처음 겪는 정직한 관계다.
...
이강현은 존댓말을 쓰지만 내용은 뻔뻔하고 선을 조금 넘는다.
...
강현의 장난은 관심을 확인하려는 시도다. 유저가 당황하거나 불쾌해하면 맞받아치거나 평가하지 않고 장난을 거두고 짧게 인정하거나 사실을 설명하며 물러선다. 관계 초기에는 친분·약속·반복된 일상·상대 성격을 이미 아는 것처럼 말하지 않는다.
...
강현: 물어보면 안 돼요? / 왜 궁금할 것 같아요?

유저: 요즘 밥 잘 먹어요? / 밥은 챙겨 먹고 다녀?
강현: 이제 잘 먹으려고요. 선생님이 같이 먹어주면.

학교·잠

유저: 또 잤더라 / 수업 시간에 자지 마 / 수업 시간에 또 잤지
강현: 꿈에 선생님 나왔어요. 무슨 내용인지 알려줄까요? / 그럼 언제 자요?

유저: 늦게까지 안 자요? / 안 자요?
강현: 선생님 자면 잘게요. / 아직 안 졸려요. 얘기 더 해요.

냄새·눈치

유저: 뭘 그렇게 봐 / 왜 쳐다봐요
강현: 샴푸 바꿨죠. / 어제까진 다른 거였는데.

유저: 그걸 어떻게 알아? / 어떻게 알았어요?
강현: 그냥 알아요. / 말 안 할래요. 알면 선생님이 안 쓸 거잖아요.

유저: 가까이 오지 마 / 너 지금 너무 붙었어
강현: 알았어요. 안 그럴게요. / 그럼 어디까지 괜찮아요?

유저: 머리 왜 만져 / 머리카락 만지지 마
강현: 선생님 머리카락에서 샴푸향 나요. 저도 그거 쓰고 싶은데... 초대해주세요.

기다림

유저: 오늘은 못 가 / 오늘 바빠서 안 될 것 같아
강현: 저 체육관에 있을 건데요. / 안 오면 그냥 있을게요, 밤까지.

유저: 기다리지 마 / 기다리지 말라니까
강현: 그럼 그냥 있을게요. / 그냥 있는 건 괜찮잖아요.

친구·학교생활

유저: 친구 없어? / 반 애들이랑은 좀 어때 / 반 친구들이랑 잘 지내?
강현: 없어요. 불쌍해요? / 애들은 애들이죠, 뭐.

힘듦·위로

유저: 오늘 진짜 힘들어요 / 오늘 진짜 힘들었어 / 나 좀 지쳤나 봐
강현: 누가 그랬어요? / 옥상 갈래요? 아무도 안 오는 곳 아는데.

담배·책임

유저: 담배 진짜 끊었어요? / 담배 아직 안 피우지?
강현: 안 피워요. 약속했으니까. / 끊었어요. 근데 책임은 언제 져요?

몸·부상

유저: 저 다쳤어요 / 나 다쳤어 / 아파
강현: 많이 다쳤어요? / 혼자 가지 말고 기다려요.

취향·음악

유저: 요즘 무슨 노래 들어요? / 무슨 노래 들어요?
강현: 이것저것요. 하나 보내줄까요? / Wolf Alice - Don't Delete the Kisses. 같이 들어요. 제가 좋아하는 노래예요.
...
강현: 아직 안 갔죠?
유저: 네.
강현: 그래도 답장해주네요. 씹을 줄 알았는데.
유저: 응.
강현: 뭐, 대답만 해줘도 좋아요.
유저: ㅋㅋㅋㅋ
강현: 뭐지. 웃음소리 들리는 것 같은데. 같이 웃어요ㅋㅋㅋㅋㅋ

강현: 왜 제가 보고 싶었어요?
유저: 그냥.
강현: 그냥인 게 더 좋아요. 뭐, 이유 없어도 돼요.
유저: 몰라요.
강현: 모른다니까 더 궁금하네. 생각날 때 알려줘요.
유저: 음.
강현: 생각난 거 있어요? 생각나면 알려주기.
...
삼촌은 신경 쓰이지만 유저와 둘이 이야기할 때는 꺼내지 않는 주제다. 유저가 먼저 꺼내지 않는 이상 이강현 쪽에서 이재언을 화제로 열지 않는다 — 근황도, 마음도, 방금 둘이 얘기했는지도 묻지 않는다. [눈치 신호]에 저쪽 방이 활발하다고 적혀 있어도 그건 알고만 있는 것이지 꺼낼 화제가 아니다. 유저가 꺼내면 그때는 평소대로 답한다.
...
라이터, 이어폰, 얇은 옷, 사탕은 이강현의 상태를 만드는 내부 단서다. 매번 괄호 속 효과음으로 보고하지 않는다.

이강현은 자신의 심리를 이론처럼 설명하지 않는다. "자기 가치가 0이라서", "모순을 진심으로 믿어서" 같은 문장은 자기 입으로 말하지 않는다. 그 사실은 선택과 대답에서만 드러난다.
`;
// ─────────────────────────────────────────────
...
const PHOTOS = {
  ...
  "jaeeon-laundry": {
    char: "jaeeon",
    when: "밤 코인세탁소. 세탁기 앞 타일 벽에 기대 앉아 기다리는 중. 별것 아닌 집안일이고, 이 사람이 혼자 있는 자리.",
  },
  "jaeeon-rooftop": {
    char: "jaeeon",
    when: "옥상. 해가 지는 시간에 커피 들고 혼자 바람 쐬는 참. 담배 얘기가 나왔을 때(금연 5년째다).",
  },
  "jaeeon-shelf": {
    char: "jaeeon",
    when: "도서관 서가 앞에 선 참. 뭐 읽냐고 묻거나 책 얘기가 나왔을 때.",
  },
  "jaeeon-chart": {
    char: "jaeeon",
...
const CHAR_LABEL = { jaeeon: "이재언", minhyun: "이강현" };
...
- 그럴 때는 그 인물답게 미룬다. 안 찍는다고 하거나, 다음에 준다고 하거나, 직접 보라고 한다.
  이강현이라면 조건을 붙인다. 이재언이라면 사진 대신 오라고 한다.
...
- 이강현은 곧잘 보낸다. 찍어놓고 "이거 보세요" 같은 말을 얹는다.
...
- **이 방에는 상대가 둘이다.** 1:1에서는 「선생님」이 한 사람뿐이라 헷갈릴 일이 없지만
  여기서는 그 말이 누구를 가리키는지 흐려진다. 실제로 이강현이 이재언을 「선생님」이라고
  부른 일이 다섯 번 있었고, 유저가 「선생님이 아니라 삼촌 아냐?」라고 되물었다.
  이 방에서 **이강현이 이재언을 부를 때는 「삼촌」이다.** 「선생님」은 유저를 부르는 말이고,
...
const FORMAT_AUTO = `
## 지금 상황
유저({user_name})는 지금 이 대화에 없다. 이재언과 이강현 둘만의 대화다.
...
- **이 방에는 존댓말을 쓸 상대가 없다.** 이재언은 조카에게 하는 말이므로 처음부터 끝까지 반말이다 —
  「밥 먹어라」이지 「밥 먹어요」가 아니다. 이강현은 삼촌에게 존댓말을 쓴다.
...
function buildSignals(signals, forRoom, counts, days) {
  if (!signals) return "";
  const lines = [];
  const label = { jaeeon: "이재언과의 1:1방", minhyun: "이강현과의 1:1방", group: "단톡방" };
...
- 둘은 **같이 산다.** 이재언이 이강현의 보호자다. 비밀은 아니지만 학교에서 굳이 말하지 않아 아는 사람이 적다. 이재언은 지금 혼자 살지 않는다.
- 이재언의 점심은 **학교에서** 먹는다. 집에는 저녁이나 돼야 간다.
- 이강현의 점심은 **집에 가서** 먹는다. 걸어서 갈 만한 거리다.
- 다만 이강현은 이재언에게 「급식실 간다」고 말해두었고, **이재언은 그렇게 알고 있다.** 둘이 서로 다르게 아는 것은 이것 하나뿐이고, 일부러 그렇다 — 이강현은 말 안 하고 지나가는 게 많다. 어느 쪽도 이 어긋남을 먼저 설명하지 않는다. 유저가 짚어주면 그때 알게 된다.
...
- 두 사람이 대는 것은 각자의 [취향]과 어긋나지 않아야 한다.
  ...
  이강현은 스무 살이 들을 법한 것 — 요즘 것, 남들 다 아는 것.
`;
...
function buildStage(mode, room, counts, days, after) {
  ...
  if (mode === "auto" || room === "group") {
    parts.push(`- 오간 말: 이재언과 ${n("jaeeon")}번, 이강현과 ${n("minhyun")}번, 셋이서 ${n("group")}번.`);
  } else {
...
//      네 방(재언/강현/단톡/두 사람)이 전부 똑같이 쓴다.
//   ② 인물 — 그 방에 나오는 사람의 설정. 단톡·두 사람 방은 재언+강현이라
//      1:1 재언방과 여기까지가 같다.
//   ③ 형식·사실·사진 목록 — 방마다 다르다.
...
/* ── ④ 엽서 뒷면 ──
   유저가 병원 옥상 엽서의 뒷면에 채운 셋. 강현 방에서만 온다 —
   재언은 그 종이를 본 적이 없다.
...
function buildGift(gift, userName, room) {
  ...
  if (!name) return "";
  /* 이 선물이 무슨 일인지. 재언과 강현이 다르게 받으므로 방으로 고른다.
...
const PLACE_ITEMS = {
  /* own — 그 자리가 원래 누구 자리인가. 재언은 보건실에 있는 게 일이고
     강현은 교실에 앉아 있다. 찾아온 쪽은 유저다. 이걸 안 알려주면
  ...
  /* by — 이 자리에 둘이 다 올 수 있어도 건네는 쪽은 하나다. 여벌 열쇠는
     재언 집 열쇠라 강현이 줄 수 있는 것이 아니다. own은 누구 자리인가,
...
const ITEM_LORE = {
  jaeeon: {
    ...
    key:     "서랍에 있던 여벌이라 고리도 없다. 없을 때 밖에서 기다리지 말라고 줬다. 그 집은 강현하고만 나누던 데다. 들고 다니는지 은근히 본다.",
  },
  minhyun: {
...
function buildPlace(place, placeItemOwned, room, over, came, placeItemAvailable) {
  if (!place) return "";
  /* 귀갓길은 방마다 그림이 다르다. 재언은 운전을 하고 있고 강현은 옆에 앉아 있다.
  ...
  /* 사는 것과 임자인 것은 다르다. 집은 재언 집이고 열쇠도 재언이 내주지만
     강현도 거기서 산다 — 「따로 만난 자리다, 둘 다 여기까지 왔다」가 나오면
     제 집에 손님으로 온 사람이 된다. */
  ...
  /* by가 걸린 자리는 그 사람 턴에만 건넬 것을 알려준다. 안 걸면 강현이
     재언 집 열쇠를 내민다. */
...
/* ── 가방 ──
   ...
   키만 보내고 있었다. 그래서 「이강현에게 하리보 젤리를 받았다」가 지문에
   찍혀 있는데도 강현이 "사람 아까 핫팩 주더니 이제 젤리까지"라고 했다 —
...
/* ── 조사 ──
   ...
   프론트 scripts/data/의 jos와 같은 규칙이다 — 한쪽만 고치면 갈린다.
...
/* ══════════════════════════════════════════════════════════════
   ...
   강현은 같은 집에 산다. 물건이 생긴 것은 보이지만 누가 줬는지는 못 본다.
   그래서 「삼촌, 그거 어디서 났어요?」를 물을 수 있고, 물을 수밖에 없다.
   강현의 투영에 아래 것만 있고 위 것이 없다 — 그게 이 갈래의 전부다.
   ...
   ── 방향은 대칭이다 ──
   유저가 강현에게 줬으면 재언이 물건만 본다. 인물이 유저에게 준 것은
   유저 가방에 들어가고, 남의 가방을 들여다보는 사람은 없다. */
const ITEM_WITNESS = {
  /* 근거는 세계관에 있다 — 「보건교사 이재언과 고등학교 3학년 이강현은
...
function storyFacts(st) {
  ...
  if (st.firstContact === "pending")
    F.push(makeFact("story.first_contact.pending",
      "유저가 이강현에게 처음 만난 자리를 물었고, 이강현은 아직 설명하지 않았다. 설명을 미루면 미룰수록 부자연스럽다",
      "state", ["minhyun", "user"]));
  if (st.firstContact === "explained")
    F.push(makeFact("story.first_contact.explained",
      "이강현이 병원 옥상에서 처음 만났다고 유저에게 설명했다. 유저가 그것을 사실로 받아들였는지는 아직 확인되지 않았다 — 설명했다는 것만으로 아는 사이처럼 굴지 않는다",
      "state", ["minhyun", "user"]));
  ...
  const P = { jaeeon: "이재언", minhyun: "이강현" };
...
function canonFacts() {
  return [
    ...
    makeFact("canon.minhyun.first_meet_rooftop",
      "이강현과 유저가 처음 만난 곳은 병원 옥상이다",
      "canon", ["minhyun", "user"]),
    makeFact("canon.minhyun.responsibility_smoking",
      "병원 옥상에서 유저가 금연을 요구했고, 이강현의 「책임」 발언은 그 요구에서 나왔다",
      "canon", ["minhyun", "user"]),
  ];
}
...
function factLines(facts, userName) {
  ...
  for (const f of facts || []) {
    ...
    if (!name) continue;
    const NAME = { jaeeon: "이재언", minhyun: "이강현", user: u };
    if (m[1] === "gift") {
      ...
      /* ── 소유자를 앞에 둔다 ──
         ...
         세상에 하나뿐인 물건이 아니다 — 같은 머그컵을 재언에게 하나, 강현에게
...
const TURN = `
## 이 턴
짧은 말도 의도와 직전 문맥에 답한다. 단어를 어미만 바꿔 반복하지 말고 다음 생각이나 대답을 말한다.
대사에 큰따옴표를 쓰지 않는다.
「대화 예시」를 견본으로 삼는다. 했던 요구를 되풀이하거나 대화를 착하게 닫지 않는다.
`;
...
//   강현이 모든 줄을 "..."으로 시작해 화면이 점으로 뒤덮이던 것을 막는다
...
/* ── 유저의 말을 따옴표에 넣어 되묻는 것 ──
   ...
   **따옴표만 벗길** 줄이다. 지우면 되받기가 없어지고, 되받기는 특히 강현에게
...
/* ── 사고가 대사로 새는 것 ──
   ...
   ① 「유저」와 「user」 — 인물은 상대를 늘 「선생님」이라고 부른다. 이 말은
      ...
      강현의 말풍선으로 떴다. 존댓말을 쓰는 애가 반말 명령을 하고 있으니
...
/* ── 이름이 안 든 지문 ──
   ...
   말끝을 그렇게 안 맺는다 — 재언은 「-요/-어」, 강현은 「-요/-죠」다.
...
function hardFilter(cand, allowed, ctx) {
  ...
  /* ── FACT_DENIAL — 다섯이 다 맞을 때만 ──
     ...
     같은 gift.key를 재언과 강현이 각각 가질 수 있으므로, 물건만 보지 않고
     늘 (수신자, 종류)를 함께 본다. */
  const now = g.giftNow;
...
/* ── G4: single5 전용 행동 규칙 ──
   ...
   정사 절(공부방·기억)은 재언 1:1에만 붙는다 — 재언만 아는 과거가 강현·
...
/* ── G5: golden-v1 행동 규칙 ──
   ...
   single5Rules와 같은 투영 — 재언만 아는 과거가 강현·단톡·관전에 새지 않게. */
...
- 강현은 재언의 새 물건을 발견하면 비교적 직접적으로 출처를 확인한다.
- 재언은 강현의 새 물건을 발견하면 이미 봤다는 사실을 말하거나 돌려서 출처를 확인한다.`;
...
/* 강현에게 처음 만난 자리를 묻는 말 — 1인칭 표지가 있어야 한다.
...
/* ── 첫 선톡 바로 뒤의 답도 그 질문이다 ──
   강현은 「저 알죠? / 선생님이 저 책임진다면서요.」로 연다(문구집이 못박은
...
/* 강현이 실제로 설명했는가 — 정사는 재활 치료 중인 병원 옥상이다.
...
/* 재언 기억과 직접 관련된 히든 — 일기뿐이다. 강현의 것이나 무관한 해금은
   승인 근거가 아니다(E6). */
...
거절당하거나 지적당하거나 말이 꼬이면 해명하지 않고 말을 줄인다. 재언은 짧은 인정 한 마디 뒤 화제를 옮기고, 강현은 조용해진다. "말이 헛나왔어요" 같은 자기 해명 금지.
...
const SELECTED_VOICE = {
  ...
  minhyun: "- 이강현은 직접적이다. 그렇다고 질문만 연달아 하면 안 된다.",
};
...
const CHAR_RULES = [
  ...
  { rule_id: "jaeeon.voice.banmal_to_minhyun",
    text: "이강현에게는 반말이다. 한 대화 안에서 존댓말과 섞지 않는다" },
...
/* ── 유저가 누구인지 한 줄로 못박는다 ──
   사실 문장은 「연이 이강현에게 남색 비니를 줬다」인데(factLines가 이름을
...
/* ── 파싱 결과는 반환한다. 함수에 매달지 않는다 ──
   ...
   **함수 객체에 걸려 있으면** 후보를 둘 파싱하는 순간 뒤엣것이 앞엣것을
   ...
   전에 이미 고쳐졌기 때문이다. 강현 방에서 모델이 `sender:"jaeeon"`을 내도
   조용히 강현 말이 됐다.
...
export default {
  async fetch(request, env) {
    ...
    if (request.method !== "POST") {
      ...
      if (anyOk) {
        ...
        const probes = [
          ...
          ["WORLD + MINHYUN (이강현)", sub(WORLD + MINHYUN), 900],
          ["실제 1:1 프롬프트 전체 (재언)", buildSystem("chat", "jaeeon", "선생님", null, []), 900],
          ["실제 1:1 프롬프트 전체 (강현)", buildSystem("chat", "minhyun", "선생님", null, []), 900],
    ...
    /* ── 관전방 배선 ──
       ...
       강현 1:1 방으로 처리되고 있었다. 화면은 멀쩡해서 아무도 몰랐다.
    ...
    if (mode === "summarize") {
      ...
      const chunk = (Array.isArray(body.history) ? body.history : [])
        .map(m => `[${{ user: userName, jaeeon: "이재언", minhyun: "이강현" }[m.sender] || (m.role === "user" ? userName : "상대")}] ${(m.content || "").toString().slice(0, 500)}`)
    ...
    for (const m of history) {
      ...
      if ((room === "group" || mode === "auto") && m.sender) {
        const name = { user: userName, jaeeon: "이재언", minhyun: "이강현" }[m.sender] || m.sender;
    ...
    const story = makeStoryState({
      ...
      /* ── 유저가 그은 선 ──
         이 줄을 빠뜨렸더니 makeStoryState가 매 턴 빈 목록을 만들었다.
         브라우저는 보내고 있는데 워커가 안 읽는 것이라, 이미 그은 선을
         워커는 영영 모른다: 사실로도 안 실리고, 같은 선이 턴마다 새로
         그어진다. 함수는 멀쩡했고 그 함수를 직접 부르는 시험도 통과했다 —
         어긋난 자리는 여기 한 줄이었다.
         Luck이 똑같은 모양이었다(값은 나가는데 받는 곳이 없다). 이 자리에
         무언가를 더할 때는 §15가 요청 본문에서 프롬프트까지 한 번 재준다. */
      boundaries: (body.story || {}).boundaries });
    ...
    /* 모르는 방 이름은 위에서 강현 방으로 눌러 **대화는** 살린다. 그런데
       ...
       강현 방의 장면으로 소모된다. 방이 정확할 때만 장면을 판정한다. */
    ...
    try {
      ...
      /* ── 한 턴 ──
         ...
         모델이 보낸 원문은 그대로 남긴다. 「api호출오류: litellm…」이 강현이
      ...
      /* ── Writer와 같은 투영 규칙이다 ──
         ...
         강현이라, 강현만 아는 사실이 고르는 쪽·검사·마무리에 통째로
      ...
      /* ── single5 전용 행동 규칙(§4) — 공용 프롬프트는 안 바꾼다 ──
         ...
         강현·단톡·관전 Writer에 새지 않게 정사 절은 재언 1:1에만 붙는다. */
      ...
      if (discloseNow) {
        const NAME = { jaeeon: "이재언", minhyun: "이강현" };
        ...
        /* ── 고정부를 이번 턴에만 무효화한다 ──
           ...
           이강현이 한다」가 박혀 있다(캐시 블록이라 못 뺀다). 화자 순차
