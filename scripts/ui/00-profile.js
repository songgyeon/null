...
function Avatar({room,size=42,onProfile,heat,nu}){
  ...
  if(room.type==="group"){
    return <div className="avatar groupavatar" style={st}><img className="specialroomicon" src="assets/ui/messenger/room-group.png?v=243" alt=""/></div>;
  }
  if(room.type==="watch"){
    return <div className="avatar watchavatar" style={st}><img className="specialroomicon" src="assets/ui/messenger/room-watch.png?v=243" alt=""/></div>;
  }
